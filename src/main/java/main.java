...
public class main {
    public static void main(String[] args) throws ParseException, IOException {
        ...
        agenda.addProfessionalContact(4, "Xerxe", 123978364, "Male", "xerxe@og.com");
        agenda.addProfessionalContact(5, "Caps", 726394867, "Male", "caps@g2.com");
        agenda.addProfessionalContact(6, "Denyk", 283749837, "Male", "denyk@misfits.com");
